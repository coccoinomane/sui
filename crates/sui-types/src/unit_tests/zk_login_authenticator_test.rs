...
use fastcrypto_zkp::bn254::zk_login::{AuxInputs, big_int_str_to_hash};
...
fn zklogin_authenticator_scenarios() {
    ...
    hasher.update(big_int_str_to_hash("600496735937200653405567117446691002318195750668637759107608398707587364969"));
